...
/**
 * get_smarttype_scene_intros — Read-Only. Retrieve the SmartType SceneIntros list (scene-heading
 * prefixes such as INT, EXT), plus the container Separator (default ". "). Mirrors Go's
...
export const getSmarttypeSceneIntrosTool = tool;
export const handleGetSmarttypeSceneIntros = handler;
