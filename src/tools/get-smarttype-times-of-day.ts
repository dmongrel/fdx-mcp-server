...
/**
 * get_smarttype_times_of_day — Read-Only. Retrieve the SmartType TimesOfDay list (times of day
 * such as DAY, NIGHT), plus the container Separator (default " - "). Mirrors Go's
...
export const getSmarttypeTimesOfDayTool = tool;
export const handleGetSmarttypeTimesOfDay = handler;
